        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 pt-2">
                <button
                    ...
                    disabled={isGenerating}
                    className="w-full cursor-pointer rounded-md bg-accent hover:bg-accent-hover px-4 py-3 text-sm font-semibold btn-accent transition disabled:cursor-not-allowed disabled:opacity-50"
                >
