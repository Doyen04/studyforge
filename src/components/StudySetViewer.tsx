            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 rounded-md bg-accent px-4 py-2 text-sm font-semibold btn-accent transition hover:bg-accent-hover disabled:opacity-50 cursor-pointer"
                    >
                    ...
                    <div className="ml-auto flex items-center gap-2 pl-4">
                        {activeTab !== "flashcards" && activeTab !== "quizzes" && countForTab(activeTab) > 0 && (
                            <button
                                ...
                                className="flex items-center gap-1.5 rounded-md bg-accent px-3 py-1.5 text-xs font-semibold btn-accent transition hover:bg-accent-hover disabled:opacity-50 cursor-pointer"
                            >
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                <Link
                                    ...
                                    className={`inline-flex items-center justify-center gap-1.5 rounded-md px-4 py-2 text-xs font-semibold transition cursor-pointer   ${dueCount > 0
                                            ? "bg-accent btn-accent hover:bg-accent-hover"
