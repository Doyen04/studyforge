            ...
            <div className="mx-auto max-w-2xl px-6 py-8 lg:py-10 space-y-6">
                ...
                <div className="flex justify-between gap-4">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 rounded-md bg-accent px-5 py-2.5 text-sm font-semibold btn-accent transition hover:bg-accent-hover disabled:opacity-50 cursor-pointer"
                    >
